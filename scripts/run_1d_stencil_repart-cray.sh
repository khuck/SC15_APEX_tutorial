...
cmd="aprun -N 1 -n 1 -d 12 ./build-cray/apex_examples/1d_stencil_4_repart --hpx:print-counter /threadqueue/length --hpx:print-counter-interval 100 --hpx:print-counter-destination /dev/null --hpx:threads 12 --nx $nx --nr $nr --nt $nt"
echo ${cmd}
${cmd}
